    ...
    <div class="main-info">
      ...
      <div class="table-info">
        ...
        >
          ...
          <el-table-column prop="name" label="下游佣金价格" width="80"/>
          <el-table-column prop="address" label="平台二次佣金价格" min-width="80" show-overflow-tooltip/>
          <el-table-column label="下游二次佣金价格" min-width="80"/>
...
export default {
  ...
  methods: {
    ...
    addAction () {
      this.$router.push({ name: 'release', params: { from: '银行' } })
    },
