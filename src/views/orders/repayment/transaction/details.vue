    ...
    <div class="head-item">
      <div class="item-info">
        <div class="order-mode">
          ...
          <span v-else-if="detail && detail.status === 1">已扣款</span>
          <span v-else-if="detail && detail.status === 2">扣款失败</span>
        </div>
    ...
    <div class="main-info">
      ...
      <div v-show="tabIndex === 0" class="tab-bd details">
        <div v-if="detail">
          <div class="row">
            <div class="item">
              <div class="label">所属计划ID</div>
              <div class="data">{{ detail.client_repay_plan_id }}</div>
            </div>
            <div class="item">
          ...
          <div class="row">
            <div class="item">
              <div class="label">订单交易费率</div>
              <!-- <div class="data">{{ (detail.rate * 100).toFixed(4) * 1000 / 1000 + '%+' + (detail.cost / 100).toFixed(2) + '元' }}</div> -->
          ...
          <!-- <div class="row">
            <div class="item">
              ...
              <div class="data">{{ (detail.amount / 100).toFixed(2) }}</div>
            </div>
            <div class="item"/>
          </div> -->
        </div>
  ...
  created () {
    ...
    getRepayOrderDetail({
      ...
      if (res.data && res.data.code === 0) {
        ...
        this.$message.error(res.data && res.data.message ? res.data.message : '获取交易管理详情失败')
      }
    }).catch(err => {
      console.log(err)
    })
